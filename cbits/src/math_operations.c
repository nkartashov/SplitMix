...
inline uint64_t xor_shift(uint32_t bits, uint64_t value);
inline uint64_t xor_shift(uint32_t bits, uint64_t value);
inline uint64_t xor_shift33(uint64_t value);
inline uint64_t first_round_mix32(uint64_t value);
inline uint64_t second_round_mix32(uint64_t value);
inline uint64_t first_round_mix64(uint64_t value);
inline uint64_t second_round_mix64(uint64_t value);
